...
pacman::p_load(tidyverse, PerformanceAnalysis, quantmod, dygraphs,tidyquant,tibbletime,knitr, timetk, broom, simfinR, memoise,scales,kableExtra )
```


```{r include=FALSE}
tickers <- c("PYPL", "SQ", "GDOT", "BKI", "FIS", "GPN")
...
prices$symbol[prices$symbol == "SQ"] <- "Square"
prices$symbol[prices$symbol == "GDOT"] <- "Global Dot"
prices$symbol[prices$symbol == "BKI"] <- "Black knight"
prices$symbol[prices$symbol == "FIS"] <- "Fidelity National inf."
prices$symbol[prices$symbol == "GPN"] <- "Global Payments"
